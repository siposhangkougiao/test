...
public class UserService {
	...
	public void edit(PageData pd) throws Exception {
		dao.update("APPUserMapper.edit",pd);
	}
	...
	public PageData finAppByUId(PageData pd) throws Exception {
		return (PageData) dao.findForObject("APPUserMapper.finAppByUId",pd);
	}
}
